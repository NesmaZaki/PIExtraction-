...
/**
 * Abstract directed edge implementation Directed connects two vertices: source
 * and target
 *
...
public class AbstractDirectedEdge<V extends IVertex> extends AbstractDirectedHyperEdge<V> implements IDirectedEdge<V>, IEdge<V> {
    ...
    public V setSource(V v) {
        ...
        ss.add(v);
        if (!this.checkEdge(ss, super.target)) {
            return null;
        }
    ...
    public V setTarget(V v) {
        ...
        ts.add(v);
        if (!this.checkEdge(super.source, ts)) {
            return null;
        }
    ...
    public boolean isSelfLoop() {
        if (this.source.equals(this.target) && this.source != null && this.target != null) {
            return true;
        } else {
            return false;
        }
    ...
    public void setVertices(V s, V t) {
        ...
        if (this.source != null && this.target != null) {
            ss.add(this.source);
            ts.add(this.target);
            // System.out.println("  SS: " + ss + " TS: " + ts);
