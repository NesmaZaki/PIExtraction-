...
public class Main {
     ...
     */
    public static void main(String[] args) throws SQLException, ParseException, ParserConfigurationException, SAXException, IOException, ClassNotFoundException, InstantiationException {

        /**
         * ****************************** Intialization of process Model of
         * synthetic log *******************************************
         */
         ...
         */
           ...
           PerformanceIndicators pis = new PerformanceIndicators();
           pis.rawPerformanceMeassure();
           
           pis.activity_measure("Service", "A_SUBMITTED");
           pis.resource_measure("Service", "112");
