...
{	
	...
	public Vertex(String name, String desc) {
        ...
        public Vertex(String name, String type , String desc, int size) {
		super(name,type,desc,size);
                
	}
        public Vertex(String name, String type , int size) {
    ...
    /**
     * @param specifyType the specifyType to set
     */
